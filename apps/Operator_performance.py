...
def L2_model(loginid,decision,time):
    model=pickle.load(open("https://raw.githubusercontent.com/Somasekhar1287/Baggage-surveillance/master/apps/l2_mlr.pkl","rb"))
    prediction=model.predict([[loginid,decision,time]])
    return prediction

def L3_model(loginid,decision,time):
    model=pickle.load(open("https://raw.githubusercontent.com/Somasekhar1287/Baggage-surveillance/master/apps/l3_mlr.pkl","rb"))
    prediction=model.predict([[loginid,decision,time]])
    return prediction
